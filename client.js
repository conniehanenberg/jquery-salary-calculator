...
$(document).ready(function() {
 ...
 // create a click binding for TableButton
    $('#clearTableButton').on('click', clearTable);

 // set up the 'Add Employee' button
    $('#addEmployee').on('click', appendEmployeeForm);

 // delete button binding higher up in the DOM
    $('table').on('click', 'deleteButton', handleDeleteButton);
...
//totalAnnualSalary += Number('totalannualsalary');
